...
* docs/versions/1_0_0/system-design.md
  * 概要: v1.0.0の基本設計書。機能一覧・相関図・依存関係（2.機能一覧）、画面一覧・遷移図（3.画面設計、S-01〜S-23）、
    共通コンポーネント（サイドバー）、データ設計・ER図（4.データ設計、30テーブル）、外部インターフェース（5.外部API連携）、
    権限マトリクス（6.ロール×機能、サブスク状態×アクセス）を定義。
