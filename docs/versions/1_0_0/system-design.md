...
|----|--------|------|--------|-----------|----------|
| F-01 | ログイン機能 | OAuth（Google / Apple / X）による認証 | MUST | 未着手 | - |
...
| F-03 | 個別銘柄ページ | 株価・ファンダメンタルズ・UOA・レーティング表示 | MUST | 未着手 | - |
| F-03-1 | 株価チャート | 時系列での株価推移表示 | MUST | 未着手 | - |
| F-03-2 | ニュースオーバーレイ | チャート上に値動きがあった日のニュースを表示 | MUST | 未着手 | - |
| F-03-3 | ファンダメンタルズ | EPS、時価総額等の基本指標表示 | MUST | 未着手 | - |
| F-03-4 | インサイダー取引 | 企業内部者の株式売買情報を表示 | MUST | 未着手 | - |
| F-03-5 | UOA表示 | Unusual Option Activity表示 | MUST | 未着手 | - |
| F-03-6 | 証券会社レーティング | 買い/保有/売り、目標株価の表示 | MUST | 未着手 | - |
| F-03-7 | 銘柄の関連ニュース | 銘柄に紐づくニュースを日付降順で表示 | MUST | 未着手 | - |
| F-03-8 | 人気記事/ニュース | 直近3ヶ月×View数で表示 | MUST | 未着手 | - |
| F-03-9 | アナリスト格付け | Massive APIによる格付け・コメント表示（ポップアップ） | MUST | 未着手 | - |
| F-04 | 記事機能 | 記事の作成・編集・公開・予約投稿 | MUST | 未着手 | - |
| F-04-1 | 記事作成・編集 | Markdownエディタによる記事作成 | MUST | 未着手 | - |
| F-04-2 | 予約投稿 | 公開日時を指定した記事公開 | MUST | 未着手 | - |
| F-04-3 | ジャンル分け | 6ジャンル程度で記事を分類表示 | MUST | 未着手 | - |
| F-04-4 | 人気記事 | 72時間以内×View数で人気記事を表示 | MUST | 未着手 | - |
| F-04-5 | 記事詳細ページ | 1つの記事の全文を表示する画面 | MUST | 未着手 | - |
| F-05 | ニュース機能 | 外部APIから自動取得、日本語翻訳、即時公開 | MUST | 未着手 | - |
| F-05-1 | ニュース自動取得 | 外部APIからニュースを取得しDBに保存 | MUST | 未着手 | - |
| F-05-2 | 日本語翻訳 | ニュースを日本語に翻訳して表示 | MUST | 未着手 | - |
| F-05-3 | トレンドニュース表示 | 直近24時間以内のニュースをスコアリング順に10個表示 | MUST | 未着手 | - |
| F-05-4 | ジャンル別ニュース表示 | 3ジャンルで各5件を最新順に表示 | MUST | 未着手 | - |
| F-05-5 | ジャンル詳細ページ | ジャンル別のニュース一覧ページ | MUST | 未着手 | - |
| F-05-6 | ニュース詳細ページ | ニュースのLLM日本語訳を表示 | WANT | 未着手 | - |
| F-06 | アンケート機能 | 最大9択、1ユーザー1回投票 | MUST | 未着手 | - |
| F-06-1 | アンケート投票画面 | 選択肢別の投票率表示、1ユーザー1回投票 | MUST | 未着手 | - |
| F-07 | 検索機能 | 記事／ニュース／銘柄／アンケートの検索 | MUST | 未着手 | - |
| F-08 | ブックマーク機能 | 記事・ニュース・アンケートのブックマーク | MUST | 未着手 | - |
| F-09 | ポートフォリオ | 銘柄をまとめて管理（最大5つ） | MUST | 未着手 | - |
| F-09-1 | ポートフォリオ管理画面 | ポートフォリオの作成・編集・削除、銘柄追加・削除 | MUST | 未着手 | - |
| F-09-2 | 関連ニュースページ | ポートフォリオに関連するニュースを独自ページで表示 | MUST | 未着手 | - |
| F-10 | 設定画面 | ユーザー設定の管理画面 | MUST | 未着手 | - |
| F-10-1 | プロフィール設定 | アイコン、userId、表示名の確認・編集 | MUST | 未着手 | - |
| F-10-2 | サブスクリプション管理 | Stripe連携、プラン確認・変更 | MUST | 未着手 | - |
| F-10-3 | メールアドレス登録 | ニュースレター受信用メールアドレスの登録・変更 | MUST | 未着手 | - |
| F-10-4 | FAQ・問い合わせ | よくある質問、問い合わせフォームへのリンク | MUST | 未着手 | - |
| F-11 | ニュースレター機能 | メール登録ユーザーに選択した記事の要約を毎日配信 | MUST | 未着手 | - |
| F-11-1 | 記事要約生成 | LLMで記事を200-300文字に要約 | MUST | 未着手 | - |
| F-11-2 | 定期配信 | 毎日朝7:30に登録ユーザーへメール送信 | MUST | 未着手 | - |
| F-12 | 管理者ページ | 管理者専用のダッシュボード | MUST | 未着手 | - |
| F-12-1 | コンテンツ管理 | 全記事・ニュース・アンケートの管理機能 | MUST | 未着手 | - |
| F-12-1-1 | 記事管理 | 全記事の一覧表示、編集、削除、予約投稿管理 | MUST | 未着手 | - |
| F-12-1-2 | ニュース管理 | 全ニュースの一覧表示、編集、削除 | MUST | 未着手 | - |
| F-12-1-3 | アンケート管理 | アンケートの作成、編集、削除、予約投稿管理 | MUST | 未着手 | - |
| F-12-2 | ユーザー管理 | ユーザー一覧、権限付与、アカウント停止 | MUST | 未着手 | - |
| F-12-3 | ニュースレター管理 | 配信リスト管理（最大5記事）、配信履歴確認 | MUST | 未着手 | - |
| F-12-4 | 設定管理 | システム設定値の管理 | MUST | 未着手 | - |
| F-12-5 | アナリティクス | Metabaseによる閲覧数・MAU・入退会数の可視化 | WANT | 未着手 | - |
...
| 画面ID | 画面名 | 概要 | 対応機能 | Figma（ノードID） |
|--------|--------|------|----------|------------------|
| S-01 | ログイン画面 | OAuth認証の選択 | F-01 | 未定義 |
| S-02 | ダッシュボード | ログイン後のホーム画面 | F-02 | `QaY2r` |
...
| S-03 | 記事一覧 | ジャンル別記事一覧 | F-04-3, F-04-4 | `kuP88` |
| S-04 | 記事詳細 | 記事本文表示、いいね、ブックマーク | F-04-5, F-08 | `Kfo7m` |
| S-05 | 記事作成・編集 | 記事の入稿・編集・予約設定（管理者/writer向け） | F-04-1, F-04-2 | 未定義 |
| S-06 | ニュース一覧 | トレンドニュース、ジャンル別ニュース表示 | F-05-3, F-05-4 | `dkBcl` |
...
| S-10 | 銘柄詳細 | 株価・ファンダ・インサイダー・UOA・レーティング表示 | F-03 | `i76cw` |
| S-11 | ポートフォリオ一覧 | 作成済みポートフォリオの一覧 | F-09 | 未定義 |
| S-12 | ポートフォリオ詳細 | ポートフォリオ内銘柄・パフォーマンス表示 | F-09-1 | 未定義 |
| S-13 | ポートフォリオ関連ニュース | ポートフォリオ関連ニュースの専用ページ | F-09-2 | 未定義 |
| S-14 | アンケート一覧 | アンケート一覧・カテゴリ絞り込み | F-06 | `0WxvH` |
| S-15 | アンケート詳細・投票 | 投票実行・結果表示 | F-06-1 | 未定義 |
| S-16 | ブックマーク一覧 | ブックマーク済みコンテンツ一覧 | F-08 | 未定義 |
| S-17 | 設定画面 | プロフィール・サブスク管理・メール登録・FAQ・問い合わせ | F-10 | `81uKN` |
| S-18 | 管理者ダッシュボード | コンテンツ管理・ユーザー管理・ニュースレター管理・設定管理・アナリティクスへのアクセス | F-12 | 未定義 |
...
```bash
# ダッシュボードのみを取得
mcp__figma__get_figma_data(fileKey="FILE_KEY_ID", nodeId="QaY2r")
```
...
- 表示内容: ポートフォリオ名・銘柄コード（ティッカー色）・変動率
- 表示形式: 縦積みリスト（最大5銘柄まで）
- 空状態: ポートフォリオ未登録時は「ポートフォリオを作成」CTA
