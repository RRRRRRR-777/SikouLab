...
| F-05-7 | ニュース手動作成・編集 | Markdownエディタによるニュース新規作成・編集。投稿ユーザー選択、ジャンル設定、予約投稿対応 | MUST | 設計完了 | `admin/home.md`（機能要件2/機能仕様3,4） |
...
| F-12-7 | 投稿ユーザー管理 | 投稿用ユーザー（表示著者）の作成・編集・削除。管理者のみ | MUST | 設計完了 | `admin/home.md`（機能要件9） |
