...
| F-10 | 設定画面 | ユーザー設定の管理画面 | MUST | 設計完了 | `settings/email.md` |
| F-10-1 | プロフィール設定 | アイコン、userId、表示名の確認・編集 | MUST | 未着手 | - |
| F-10-2 | サブスクリプション管理 | Stripe連携、プラン確認・変更 | MUST | 未着手 | - |
| F-10-3 | メールアドレス登録 | ニュースレター受信用メールアドレスの登録・変更 | MUST | 設計完了 | `settings/email.md` |
...
| F-12-3 | ニュースレター管理 | 配信リスト管理（最大5記事）、配信履歴確認 | MUST | 設計完了 | `newsletter/manage.md` |
