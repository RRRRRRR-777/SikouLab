...
バージョン単位の基本設計書として、`docs/versions/<version>/basic-design.md` を作成するSkillです。
...
```
docs/versions/<version>/basic-design.md
```

例: `docs/versions/1_0_0/basic-design.md`
